...
public class BookController {
    ...
    public ResponseEntity add(@RequestParam(name = "title") String title,
        ...
        Date publishDate) {
/*    public ResponseEntity add(@ResponseBody Book book) {*/
        try {
